    ...
    >
      <div className="flex flex-col md:flex-row gap-6 mb-6">
        ...
        <div className="md:w-1/3">
          <Button 
            className="w-full h-full rounded-xl bg-[#69ad4c] hover:bg-[#69ad4c] text-white flex flex-col items-center justify-center text-3xl font-bold p-6 transition-all duration-200 shadow-md hover:shadow-lg hover:shadow-[#69ad4c]/30"
