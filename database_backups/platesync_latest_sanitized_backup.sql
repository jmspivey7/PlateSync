...
CREATE TABLE public.users (
    ...
    password_reset_token character varyingREDACTED";
    password_reset_expires timestamp with time zoneREDACTED";
    password character varyingREDACTED";
...
COPY public.users (id, username, email, first_name, last_name, bio, profile_image_url, created_at, updated_at, church_name, email_notifications_enabled, role, password_reset_token, password_reset_expires, password, is_verified, church_logo_url, church_id, is_master_admin) FROM stdinREDACTED";
